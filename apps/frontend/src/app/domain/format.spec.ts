...
describe("formatAmount", () => {
    it("puts the symbol after the amount, separated by a non-breaking space", () => {
        // The handoff is explicit about the order: symbol last, not `€87,40`.
    ...
    it("always shows two decimals, with German separators", () => {
...
describe("date formatting", () => {
    ...
    it("renders D. Month YYYY for section headers", () => {
    ...
    it("does not shift the day in a negative UTC offset", () => {
        ...
        expect(formatDateLong("2026-01-01")).toBe("1. Jänner 2026");
    });
